  ...
  return (
    <div className="page-content">
      <div className="page-header">
        ...
        <p>Explore government schemes and programs for health sector.</p>
      </div>
      ...
      {!loading && !error && schemes.length === 0 && (
        <div className="no-schemes">
          <h3>No Health Schemes Available</h3>
          <p>There are currently no health schemes in our database.</p>
        </div>
      )}
      ...
      {!loading && !error && schemes.length > 0 && filteredSchemes.length === 0 && searchTerm && (
        <div className="no-schemes">
          ...
          <p>No health schemes match your search for "{searchTerm}".</p>
