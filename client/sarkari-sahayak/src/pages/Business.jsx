  ...
  return (
    <div className="page-content">
      <div className="page-header">
        ...
        <h1>Business Schemes</h1>
        <p>Explore government schemes and programs for business sector.</p>
      </div>
      ...
      <div className="search-container">
        <div className="search-box">
          ...
          <input
            type="text"
            placeholder="Search business schemes..."
            value={searchTerm}
      ...
      {!loading && !error && schemes.length === 0 && (
        <div className="no-schemes">
          <h3>No Business Schemes Available</h3>
          <p>There are currently no business schemes in our database.</p>
        </div>
      )}
      ...
      {!loading && !error && schemes.length > 0 && filteredSchemes.length === 0 && searchTerm && (
        <div className="no-schemes">
          ...
          <p>No business schemes match your search for "{searchTerm}".</p>
