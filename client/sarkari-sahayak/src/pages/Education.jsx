    ...
    <div className="page-content">
      ...
      <div className="search-container">
        <div className="search-box">
          ...
          <input
            type="text"
            placeholder="Search education schemes..."
            value={searchTerm}
      ...
      {!loading && !error && schemes.length === 0 && (
        <div className="no-schemes">
          <h3>No Education Schemes Available</h3>
          <p>There are currently no education schemes in our database.</p>
        </div>
      )}
      ...
      {!loading && !error && schemes.length > 0 && filteredSchemes.length === 0 && searchTerm && (
        <div className="no-schemes">
          ...
          <p>No education schemes match your search for "{searchTerm}".</p>
